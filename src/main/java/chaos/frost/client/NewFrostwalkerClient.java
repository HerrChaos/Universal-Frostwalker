    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (ModKeybinds.TOGGLE_FROST_WALKER.wasPressed() && client.player != null) {
                ...
                client.player.setAttached(ModDataAttachments.IS_FROSTWALKER_ENABLED, isFrostWalkerEnabled);
                ClientPlayNetworking.send(new ToggleFrostwalkerC2SPacket(isFrostWalkerEnabled));
