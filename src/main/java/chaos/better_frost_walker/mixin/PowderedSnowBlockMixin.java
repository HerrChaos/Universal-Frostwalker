...
public abstract class PowderedSnowBlockMixin {
    ...
    private static boolean betterfrostwalker$standOnPowderedSnowWithFrostWalker(boolean original, Entity entity) {
        if (!BetterFrostWalkerMain.config.get().standingOnPowderedSnow) return original;
